...
async function main() {
  ...
  // ─── Voice Presets ─────────────────────────────────────────────────────────
  const voicePresets = await Promise.all([
    prisma.voicePreset.upsert({
      where: { ttsVoiceName_languageCode: { ttsVoiceName: "ko-KR-Neural2-A", languageCode: "ko-KR" } },
      update: {},
      create: { name: "Kim Professor (Female)", ttsVoiceName: "ko-KR-Neural2-A", languageCode: "ko-KR", gender: "FEMALE", voiceType: "Neural2" },
    }),
    prisma.voicePreset.upsert({
      where: { ttsVoiceName_languageCode: { ttsVoiceName: "ko-KR-Neural2-C", languageCode: "ko-KR" } },
      update: {},
      create: { name: "Park Doctor (Male)", ttsVoiceName: "ko-KR-Neural2-C", languageCode: "ko-KR", gender: "MALE", voiceType: "Neural2" },
    }),
    prisma.voicePreset.upsert({
      where: { ttsVoiceName_languageCode: { ttsVoiceName: "en-US-Neural2-C", languageCode: "en-US" } },
      update: {},
      create: { name: "Sarah (Female)", ttsVoiceName: "en-US-Neural2-C", languageCode: "en-US", gender: "FEMALE", voiceType: "Neural2" },
    }),
    prisma.voicePreset.upsert({
      where: { ttsVoiceName_languageCode: { ttsVoiceName: "en-US-Neural2-D", languageCode: "en-US" } },
      update: {},
      create: { name: "James (Male)", ttsVoiceName: "en-US-Neural2-D", languageCode: "en-US", gender: "MALE", voiceType: "Neural2" },
    }),
    prisma.voicePreset.upsert({
      where: { ttsVoiceName_languageCode: { ttsVoiceName: "en-US-Studio-O", languageCode: "en-US" } },
      update: {},
      create: { name: "Dr. Miller (Female, Studio)", ttsVoiceName: "en-US-Studio-O", languageCode: "en-US", gender: "FEMALE", voiceType: "Studio" },
    }),
    prisma.voicePreset.upsert({
      where: { ttsVoiceName_languageCode: { ttsVoiceName: "en-US-Studio-Q", languageCode: "en-US" } },
      update: {},
      create: { name: "Dr. Anderson (Male, Studio)", ttsVoiceName: "en-US-Studio-Q", languageCode: "en-US", gender: "MALE", voiceType: "Studio" },
    }),
    prisma.voicePreset.upsert({
      where: { ttsVoiceName_languageCode: { ttsVoiceName: "fr-FR-Neural2-A", languageCode: "fr-FR" } },
      update: {},
      create: { name: "Marie (Female)", ttsVoiceName: "fr-FR-Neural2-A", languageCode: "fr-FR", gender: "FEMALE", voiceType: "Neural2" },
    }),
    prisma.voicePreset.upsert({
      where: { ttsVoiceName_languageCode: { ttsVoiceName: "es-ES-Neural2-A", languageCode: "es-ES" } },
      update: {},
      create: { name: "Carmen (Female)", ttsVoiceName: "es-ES-Neural2-A", languageCode: "es-ES", gender: "FEMALE", voiceType: "Neural2" },
    }),
  ]);
  console.log(`✅ Voice presets: ${voicePresets.length}`);
  ...
  const promptTemplates = await Promise.all([
    prisma.promptTemplate.create({
      data: {
        ...
        promptTemplate: "Proper hand hygiene technique following WHO guidelines for healthcare workers in resource-limited settings",
    ...
    prisma.promptTemplate.create({
      data: {
        ...
        promptTemplate: "Systematic approach to patient assessment including vital signs, history taking, and physical examination for primary healthcare workers",
    ...
    prisma.promptTemplate.create({
      data: {
        ...
        promptTemplate: "Emergency triage system for rural clinics, covering START triage method and critical decision-making in mass casualty scenarios",
    ...
    prisma.promptTemplate.create({
      data: {
        ...
        promptTemplate: "Safe medication administration including the 5 rights of medication, common drug interactions, and adverse reaction recognition",
    ...
    prisma.promptTemplate.create({
      data: {
        ...
        promptTemplate: "Basic wound care and dressing techniques including wound assessment, cleaning, and appropriate dressing selection for different wound types",
        defaultConfig: { riskLevel: "L1", duration: 180 },
        locale: "en",
      },
    }),
    prisma.promptTemplate.create({
      data: {
        ...
        promptTemplate: "Step-by-step guide for donning and doffing Personal Protective Equipment (PPE) for infection prevention in healthcare settings",
